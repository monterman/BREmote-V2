...
{key:"rtm_double_squeeze_en",label:"RTM Double-Squeeze",description:"SHIPPED DEFAULT IS 0 (single squeeze) — that is what defaultConf actually writes on a factory reset, even though the struct comment beside it still says 'default 1'. The firmware is self-contradictory here; this page follows defaultConf. RECOMMENDED: set this to 1 (double-squeeze). 1 = you must squeeze the throttle TWICE to engage RTM — the deliberate, harder-to-trigger-by-accident gesture. 0 = a SINGLE squeeze engages RTM (hold ~500 ms) — easier, but easier to trigger unintentionally.",group:"RTM",type:"bool",def:0,min:0,max:1},
