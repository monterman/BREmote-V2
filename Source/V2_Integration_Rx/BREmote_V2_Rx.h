...
#define SW_VERSION 33  // V2.5-Evo — 33 = motor_ramp_s (motor ramping, secs) added to confStruct; first flash resets all RX SPIFFS config to defaults
