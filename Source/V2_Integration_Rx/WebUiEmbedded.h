...
{key:"followme_mode",label:"Follow-Me Mode",description:"Persisted default FM mode (used as the 0xFF fallback when the TX has not sent a runtime override). 0=Disabled (RTM throttle-limit only, no steering), 1=Near Right (rear-right diagonal, default), 2=Behind (directly behind foiler), 3=Near Left (rear-left diagonal). Default 1.",group:"Follow-Me",type:"enum",def:1,min:0,max:3,options:[{v:0,l:"Disabled"},{v:1,l:"Near Right (default)"},{v:2,l:"Behind"},{v:3,l:"Near Left"}]},
