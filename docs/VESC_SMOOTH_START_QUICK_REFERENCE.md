...
- `C:\Users\Andress Montero\My Drive\Projects\BREmote\docs\VESC_FOC_TUNING_NOTES.md` — full deep dive on FOC tuning, FOC-vs-BLDC, and parameter analogies
- `C:\Users\Andress Montero\My Drive\Projects\BREmote\docs\THROTTLE_PIPELINE_ANALYSIS.md` — BREmote-side throttle pipeline analysis and recommendations
