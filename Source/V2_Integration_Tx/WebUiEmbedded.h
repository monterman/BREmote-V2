...
{key:"rtm_hold_duration_s",label:"RTM Arm Hold Time",description:"LEFT-hold (combo) duration to arm RTM. Live and tunable: 4=fast arm, 10=very deliberate. Default 5.",group:"RTM",type:"int",def:5,min:4,max:10,unit:"s"},
...
{key:"fm_hold_duration_s",label:"FM Hold Time",description:"RIGHT-hold (combo) duration to cycle Follow-Me mode. Live and tunable: 4=fast, 10=very deliberate. Default 5.",group:"Follow-Me",type:"int",def:5,min:4,max:10,unit:"s"},
