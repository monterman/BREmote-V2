...
{key:"rtm_stop_distance_m",label:"RTM Hard Stop Distance",description:"Distance at which RTM triggers a hard stop and disengages (Gate 9). Range 1-50 m, default 3 m. Must be less than the arm distance to allow RTM to run.",group:"RTM",type:"int",def:3,min:1,max:50,unit:"m"},
