...
{key:"mag_scale_x",label:"Compass Scale X",description:"Soft-iron calibration scale for X axis. 1.0=unity gain (no correction). Set automatically by ?compasscal — do not edit manually unless restoring a known-good backup. Range 0.1-10.0.",group:"GPS",type:"float",def:1.0,min:0.1,max:10.0,step:0.001},
{key:"mag_scale_y",label:"Compass Scale Y",description:"Soft-iron calibration scale for Y axis. 1.0=unity gain (no correction). Set automatically by ?compasscal — do not edit manually unless restoring a known-good backup. Range 0.1-10.0.",group:"GPS",type:"float",def:1.0,min:0.1,max:10.0,step:0.001},
...
{key:"rtm_compass_required",label:"RTM Compass Required",description:"Require valid compass reading for RTM arming. 0=allow RTM without compass (steering disabled). Default 1.",group:"RTM",type:"bool",def:1,min:0,max:1},
